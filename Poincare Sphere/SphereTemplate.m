...
ht_x = text(1.75,0,0,'+S_1','fontweight','bold','fontsize',16,'fontname','arial');
Hy = plot3([0 0], [-1.5 1.5], [0 0],'k-');
set(Hy,'linewidth',2,'linestyle','-','color','k');
ht_y = text(0.1,1.6,0,'+S_2','fontweight','bold','fontsize',16,'fontname','arial');
Hz = plot3([0 0], [0 0], [-1.5 1.5],'k-');
set(Hz,'linewidth',2,'linestyle','-','color','k');
ht_z = text(-0.05,0,1.35,'+S_3','fontweight','bold','fontsize',16,'fontname','arial');
ht_lcp = text(-0.05,0.0,1.1,'V_{21}^+','fontweight','bold','fontsize',16,'fontname','arial','color','k');
