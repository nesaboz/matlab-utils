function [cubePol1, cubePol2, M, pathname, timing, ID, lambda, L] = LoadAndExtractCubesWithDrift(pathname1) % Ring
clc;

[stack, pathname] = LoadStack(pathname1);
...
% 4) crop cubes
[cubePol1, cubePol2, M] = ExtractTwoCubesHorizontalWithDrift1(cube);
